...
def average_graph_complexity(generators: PauliStringCollection, p: PauliString):
    """
    Return the average graph complexity of a Pauli string in the commutator graph
    generated by a given generating set.

    Args:
        generators: Generating set for the dynamical Lie algebra
